...
select e.emp_id, e.emp_name, b.*, count(i.issued_id) as no_of_books_processed
...
select i.issued_member_id, i.issued_book_name, i.issued_book_isbn, count(r.book_quality) as No_of_damaged_books
from issued_status i
...
select b.isbn, b.book_title, b.rental_price, i.issued_member_id, i.issued_date, r.return_date, (current_date - i.issued_date) as no_of_days_after_issuing
from issued_status i 
inner join books b
